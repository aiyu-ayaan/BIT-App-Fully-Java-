package com.aatec.bit.Bottom_Navigation.Syllabus.BCA.Sem2;
...
public class bca_sem_2 extends Fragment implements View.OnClickListener {
    private LinearLayout[] buttons = new LinearLayout[7];

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.frag_bca_sem_2, container, false);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.book1:
                getActivity().startActivity(new Intent(getContext(), bca_2_1.class));
                break;
            case R.id.book2:
                getActivity().startActivity(new Intent(getContext(), bca_2_2.class));
                break;
            case R.id.book3:
                getActivity().startActivity(new Intent(getContext(), bca_2_3.class));
                break;
            case R.id.book4:
                getActivity().startActivity(new Intent(getContext(), bca_2_4.class));
                break;
            case R.id.book5:
                getActivity().startActivity(new Intent(getContext(), bca_2_5.class));
                break;
            case R.id.book6:
                getActivity().startActivity(new Intent(getContext(), bca_2_6.class));
                break;
            case R.id.book7:
                getActivity().startActivity(new Intent(getContext(), bca_2_7.class));
                break;
        }
    }
}
