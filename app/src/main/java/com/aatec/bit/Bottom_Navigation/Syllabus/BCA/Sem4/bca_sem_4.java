package com.aatec.bit.Bottom_Navigation.Syllabus.BCA.Sem4;
...
public class bca_sem_4 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.frag_bca_sem_4, container, false);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.book1:
                getActivity().startActivity(new Intent(getContext(), bca_4_1.class));
                break;
            case R.id.book2:
                getActivity().startActivity(new Intent(getContext(), bca_4_2.class));
                break;
            case R.id.book3:
                getActivity().startActivity(new Intent(getContext(), bca_4_3.class));
                break;
            case R.id.book4:
                getActivity().startActivity(new Intent(getContext(), bca_4_4.class));
                break;
            case R.id.book5:
                getActivity().startActivity(new Intent(getContext(), bca_4_5.class));
                break;
            case R.id.book6:
                getActivity().startActivity(new Intent(getContext(), bca_4_6.class));
                break;
            case R.id.book7:
                getActivity().startActivity(new Intent(getContext(), bca_4_7.class));
                break;
            case R.id.book8:
                getActivity().startActivity(new Intent(getContext(), bca_4_8.class));
                break;
            case R.id.book9:
                getActivity().startActivity(new Intent(getContext(), bca_4_9.class));
                break;
            case R.id.book10:
                getActivity().startActivity(new Intent(getContext(), bca_4_10.class));
                break;
            case R.id.book11:
                getActivity().startActivity(new Intent(getContext(), bca_4_11.class));
                break;
