package com.aatec.bit.Bottom_Navigation.Syllabus.MCA.Sem3;
...
import com.aatec.bit.Bottom_Navigation.Syllabus.MCA.Sem3.Books.mca_3_6;
import com.aatec.bit.R;

public class mca_sem_3 extends Fragment implements View.OnClickListener {
    private LinearLayout[] buttons = new LinearLayout[6];

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.frag_mca_sem_3, container, false);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.book1:
                getActivity().startActivity(new Intent(getContext(), mca_3_1.class));
                break;
            case R.id.book2:
                getActivity().startActivity(new Intent(getContext(), mca_3_2.class));
                break;
            case R.id.book3:
                getActivity().startActivity(new Intent(getContext(), mca_3_3.class));
                break;
            case R.id.book4:
                getActivity().startActivity(new Intent(getContext(), mca_3_4.class));
                break;
            case R.id.book5:
                getActivity().startActivity(new Intent(getContext(), mca_3_5.class));
                break;
            case R.id.book6:
                getActivity().startActivity(new Intent(getContext(), mca_3_6.class));
                break;
        }
    }
}
